...
const Profile = () => {
  ...
  const fetchUserDetails = async () => {
    try {
      const res = await axios.get(
        `http://13.51.176.106:3002/user/profile/${userId}`
      );
  ...
  const checkFollowStatus = async () => {
    try {
      const res = await axios.get(
        `http://13.51.176.106:3002/user/is-following/${userId}/${profileUserId}`
      );
  ...
  const handleFollow = async () => {
    ...
    try {
      await axios.post(`http://13.51.176.106:3002/user/follow`, {
        followerId: userId,
